...
public class DiscountAlterationCommand extends PriceAlterationCommand {

    public DiscountAlterationCommand(CartPrice cartPrice, PriceAlteration priceAlteration) {
